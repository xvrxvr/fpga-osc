...
#                script (type 'clk_wiz_main.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_wiz_main xil_defaultlib.glbl -o clk_wiz_main_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_wiz_main_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clk_wiz_main_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_wiz_main_simv.daidir vcs_lib c.obj)
