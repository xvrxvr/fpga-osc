...
#
# Script generated by Vivado on Tue Mar 12 11:35:05 +0000 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_wiz_main.sh
...
#
# Usage        : clk_wiz_main.sh
#                clk_wiz_main.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_main.sh [-reset_run]
#                clk_wiz_main.sh [-reset_log]
#                clk_wiz_main.sh [-help]
#
...
# script info
echo -e "clk_wiz_main.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_main.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_wiz_main xil_defaultlib.clk_wiz_main xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim clk_wiz_main -key {Behavioral:sim_1:Functional:clk_wiz_main} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_wiz_main.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_wiz_main.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_wiz_main.sh [-help]\n\
Usage: clk_wiz_main.sh [-step]\n\
Usage: clk_wiz_main.sh [-lib_map_path]\n\
Usage: clk_wiz_main.sh [-reset_run]\n\
Usage: clk_wiz_main.sh [-reset_log]\n\
Usage: clk_wiz_main.sh [-keep_index]\n\
Usage: clk_wiz_main.sh [-noclean_files]\n\n\
