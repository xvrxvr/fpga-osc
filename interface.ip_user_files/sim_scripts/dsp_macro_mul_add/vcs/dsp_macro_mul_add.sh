...
design_libs=(xpm xbip_dsp48_wrapper_v3_0_5 xbip_utils_v3_0_12 xbip_pipe_v3_0_8 dsp_macro_v1_0_5 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work dsp_macro_v1_0_5 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dsp_macro_mul_add xil_defaultlib.glbl -o dsp_macro_mul_add_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dsp_macro_mul_add_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dsp_macro_mul_add_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dsp_macro_mul_add_simv.daidir vcs_lib c.obj)
