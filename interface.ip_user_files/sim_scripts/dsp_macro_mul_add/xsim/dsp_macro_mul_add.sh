...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_dsp48_wrapper_v3_0_5 -L xbip_utils_v3_0_12 -L xbip_pipe_v3_0_8 -L dsp_macro_v1_0_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dsp_macro_mul_add xil_defaultlib.dsp_macro_mul_add xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_macro_mul_add -key {Behavioral:sim_1:Functional:dsp_macro_mul_add} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_macro_mul_add.wdb xsim.dir libdpi.so)
