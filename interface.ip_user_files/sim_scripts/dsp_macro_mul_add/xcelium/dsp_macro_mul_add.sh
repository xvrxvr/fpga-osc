...
#
# Script generated by Vivado on Wed Feb 28 12:45:34 +0000 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dsp_macro_mul_add.sh
...
#
# Usage        : dsp_macro_mul_add.sh
#                dsp_macro_mul_add.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_macro_mul_add.sh [-reset_run]
#                dsp_macro_mul_add.sh [-reset_log]
#                dsp_macro_mul_add.sh [-help]
#
...
#                script (type 'dsp_macro_mul_add.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_utils_v3_0_12 -libname xbip_pipe_v3_0_8 -libname dsp_macro_v1_0_5 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_dsp48_wrapper_v3_0_5 xbip_utils_v3_0_12 xbip_pipe_v3_0_8 dsp_macro_v1_0_5 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "dsp_macro_mul_add.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_macro_mul_add.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work dsp_macro_v1_0_5 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.dsp_macro_mul_add xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.dsp_macro_mul_add -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log dsp_macro_mul_add_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_macro_mul_add.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_macro_mul_add.sh [-help]\n\
Usage: dsp_macro_mul_add.sh [-step]\n\
Usage: dsp_macro_mul_add.sh [-lib_map_path]\n\
Usage: dsp_macro_mul_add.sh [-reset_run]\n\
Usage: dsp_macro_mul_add.sh [-reset_log]\n\
Usage: dsp_macro_mul_add.sh [-keep_index]\n\
Usage: dsp_macro_mul_add.sh [-noclean_files]\n\n\
