...
#
# Script generated by Vivado on Sat Jun 08 21:06:48 +0100 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi4stream_vip_1.sh
...
#
# Usage        : axi4stream_vip_1.sh
#                axi4stream_vip_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi4stream_vip_1.sh [-reset_run]
#                axi4stream_vip_1.sh [-reset_log]
#                axi4stream_vip_1.sh [-help]
#
...
#                script (type 'axi4stream_vip_1.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axis_infrastructure_v1_1_1 -libname xil_defaultlib -libname axi4stream_vip_v1_1_16 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axis_infrastructure_v1_1_1 xil_defaultlib axi4stream_vip_v1_1_16)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi4stream_vip_1.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi4stream_vip_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work axis_infrastructure_v1_1_1 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../interface.gen/sources_1/ip/axi4stream_vip_1/sim/axi4stream_vip_1_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi4stream_vip_v1_1_16 $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi4stream_vip_1 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi4stream_vip_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi4stream_vip_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi4stream_vip_1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi4stream_vip_1.sh [-help]\n\
Usage: axi4stream_vip_1.sh [-step]\n\
Usage: axi4stream_vip_1.sh [-lib_map_path]\n\
Usage: axi4stream_vip_1.sh [-reset_run]\n\
Usage: axi4stream_vip_1.sh [-reset_log]\n\
Usage: axi4stream_vip_1.sh [-keep_index]\n\
Usage: axi4stream_vip_1.sh [-noclean_files]\n\n\
