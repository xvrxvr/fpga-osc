...
design_libs=(xilinx_vip xpm axis_infrastructure_v1_1_1 xil_defaultlib axi4stream_vip_v1_1_16)
...
compile()
{
  ...
  vlogan -work axis_infrastructure_v1_1_1 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../interface.gen/sources_1/ip/axi4stream_vip_1/sim/axi4stream_vip_1_pkg.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi4stream_vip_v1_1_16 $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi4stream_vip_1 xil_defaultlib.glbl -o axi4stream_vip_1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi4stream_vip_1_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi4stream_vip_1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi4stream_vip_1_simv.daidir vcs_lib c.obj)
