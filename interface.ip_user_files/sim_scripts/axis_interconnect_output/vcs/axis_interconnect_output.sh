...
design_libs=(xpm fifo_generator_v13_2_9 axis_interconnect_v1_1_22 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work axis_interconnect_v1_1_22 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" \
