...
design_libs=(xilinx_vip xpm fifo_generator_v13_2_9 axis_interconnect_v1_1_22 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axis_interconnect_v1_1_22 $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_interconnect_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_interconnect_output xil_defaultlib.glbl -o axis_interconnect_output_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_interconnect_output_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axis_interconnect_output_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_interconnect_output_simv.daidir vcs_lib c.obj)
