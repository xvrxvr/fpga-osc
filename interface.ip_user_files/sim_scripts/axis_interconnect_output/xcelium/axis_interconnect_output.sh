...
#
# Script generated by Vivado on Fri May 31 19:47:03 +0100 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_interconnect_output.sh
...
#
# Usage        : axis_interconnect_output.sh
#                axis_interconnect_output.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_interconnect_output.sh [-reset_run]
#                axis_interconnect_output.sh [-reset_log]
#                axis_interconnect_output.sh [-help]
#
...
#                script (type 'axis_interconnect_output.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname fifo_generator_v13_2_9 -libname axis_interconnect_v1_1_22 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm fifo_generator_v13_2_9 axis_interconnect_v1_1_22 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axis_interconnect_output.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_interconnect_output.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axis_interconnect_v1_1_22 $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../ipstatic/hdl/axis_interconnect_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../ipstatic/hdl" +incdir+"Z:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_interconnect_output xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_interconnect_output -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_interconnect_output_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_interconnect_output.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_interconnect_output.sh [-help]\n\
Usage: axis_interconnect_output.sh [-step]\n\
Usage: axis_interconnect_output.sh [-lib_map_path]\n\
Usage: axis_interconnect_output.sh [-reset_run]\n\
Usage: axis_interconnect_output.sh [-reset_log]\n\
Usage: axis_interconnect_output.sh [-keep_index]\n\
Usage: axis_interconnect_output.sh [-noclean_files]\n\n\
