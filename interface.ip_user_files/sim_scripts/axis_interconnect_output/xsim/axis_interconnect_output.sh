...
# set xvlog options
xvlog_opts="--incr --relax  -L axi4stream_vip_v1_1_16 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L axis_interconnect_v1_1_22 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axis_interconnect_output xil_defaultlib.axis_interconnect_output xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axis_interconnect_output -key {Behavioral:sim_1:Functional:axis_interconnect_output} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="Z:/Xilinx/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axis_interconnect_output.wdb xsim.dir libdpi.so)
