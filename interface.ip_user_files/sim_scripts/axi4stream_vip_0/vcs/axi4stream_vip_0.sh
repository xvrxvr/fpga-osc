...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi4stream_vip_0 xil_defaultlib.glbl -o axi4stream_vip_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi4stream_vip_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi4stream_vip_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi4stream_vip_0_simv.daidir vcs_lib c.obj)
