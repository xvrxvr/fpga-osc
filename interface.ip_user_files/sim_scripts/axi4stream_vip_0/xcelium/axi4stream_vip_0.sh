...
#
# Script generated by Vivado on Sat Jun 08 21:04:30 +0100 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi4stream_vip_0.sh
...
#
# Usage        : axi4stream_vip_0.sh
#                axi4stream_vip_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi4stream_vip_0.sh [-reset_run]
#                axi4stream_vip_0.sh [-reset_log]
#                axi4stream_vip_0.sh [-help]
#
...
#                script (type 'axi4stream_vip_0.sh -help' for more information).
#
...
# script info
echo -e "axi4stream_vip_0.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi4stream_vip_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi4stream_vip_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi4stream_vip_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi4stream_vip_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi4stream_vip_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi4stream_vip_0.sh [-help]\n\
Usage: axi4stream_vip_0.sh [-step]\n\
Usage: axi4stream_vip_0.sh [-lib_map_path]\n\
Usage: axi4stream_vip_0.sh [-reset_run]\n\
Usage: axi4stream_vip_0.sh [-reset_log]\n\
Usage: axi4stream_vip_0.sh [-keep_index]\n\
Usage: axi4stream_vip_0.sh [-noclean_files]\n\n\
