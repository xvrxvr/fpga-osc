...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axis_interconnect_input xil_defaultlib.glbl -o axis_interconnect_input_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axis_interconnect_input_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axis_interconnect_input_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axis_interconnect_input_simv.daidir vcs_lib c.obj)
