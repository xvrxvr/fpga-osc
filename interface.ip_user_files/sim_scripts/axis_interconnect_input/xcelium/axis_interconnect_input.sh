...
#
# Script generated by Vivado on Fri May 31 19:46:40 +0100 2024
# SW Build 4126759 on Thu Feb  8 23:53:51 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axis_interconnect_input.sh
...
#
# Usage        : axis_interconnect_input.sh
#                axis_interconnect_input.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axis_interconnect_input.sh [-reset_run]
#                axis_interconnect_input.sh [-reset_log]
#                axis_interconnect_input.sh [-help]
#
...
#                script (type 'axis_interconnect_input.sh -help' for more information).
#
...
# script info
echo -e "axis_interconnect_input.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axis_interconnect_input.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axis_interconnect_input xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axis_interconnect_input -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axis_interconnect_input_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axis_interconnect_input.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axis_interconnect_input.sh [-help]\n\
Usage: axis_interconnect_input.sh [-step]\n\
Usage: axis_interconnect_input.sh [-lib_map_path]\n\
Usage: axis_interconnect_input.sh [-reset_run]\n\
Usage: axis_interconnect_input.sh [-reset_log]\n\
Usage: axis_interconnect_input.sh [-keep_index]\n\
Usage: axis_interconnect_input.sh [-noclean_files]\n\n\
