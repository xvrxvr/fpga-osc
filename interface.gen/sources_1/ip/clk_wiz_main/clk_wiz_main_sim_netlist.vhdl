...
--               w:/home/roman/FPGA-HAT/fw/interface/interface.gen/sources_1/ip/clk_wiz_main/clk_wiz_main_sim_netlist.vhdl
-- Design      : clk_wiz_main
...
entity clk_wiz_main_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
end clk_wiz_main_clk_wiz;

architecture STRUCTURE of clk_wiz_main_clk_wiz is
  signal clk_in1_clk_wiz_main : STD_LOGIC;
  signal clk_out1_clk_wiz_main : STD_LOGIC;
  signal clk_out1_clk_wiz_main_en_clk : STD_LOGIC;
  signal clkfbout_buf_clk_wiz_main : STD_LOGIC;
  signal clkfbout_clk_wiz_main : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_clk_wiz_main,
      O => clkfbout_buf_clk_wiz_main
    );
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_clk_wiz_main,
      O => clk_out1_clk_wiz_main_en_clk
    );
mmcm_adv_inst: unisim.vcomponents.MMCME2_ADV
    generic map(
      ...
      STARTUP_WAIT => false
        ...
        port map (
      CLKFBIN => clkfbout_buf_clk_wiz_main,
      CLKFBOUT => clkfbout_clk_wiz_main,
      CLKFBOUTB => NLW_mmcm_adv_inst_CLKFBOUTB_UNCONNECTED,
      CLKFBSTOPPED => NLW_mmcm_adv_inst_CLKFBSTOPPED_UNCONNECTED,
      CLKIN1 => clk_in1_clk_wiz_main,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcm_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_clk_wiz_main,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_clk_wiz_main_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg1(0),
      R => '0'
...
entity clk_wiz_main is
  ...
  attribute NotValidForBitStream of clk_wiz_main : entity is true;
end clk_wiz_main;

architecture STRUCTURE of clk_wiz_main is
begin
inst: entity work.clk_wiz_main_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1
    );
